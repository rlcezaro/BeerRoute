...
namespace BeerRoute.Controllers
{
    public class VisitasController : Controller
    {
        ...
        {
            ViewData["CervejariaId"] = new SelectList(_context.Cervejaria, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,UsuarioId,CervejariaId,DataVisita,CreditosUtilizados,Avaliacao,Comentario")] Visita visita)
        {
            ...
            ViewData["CervejariaId"] = new SelectList(_context.Cervejaria, "Id", "Id", visita.CervejariaId);
            ViewData["UsuarioId"] = new SelectList(_context.Usuario, "Id", "Id", visita.UsuarioId);
            return View(visita);
        }
